...
function ContactUs({ detailedMode = false }: { detailedMode?: boolean }) {
  ...
  return (
    <>
      ...
      <div className="flex py-12 px-4 mx-16 border-l-[3px] border-r-[3px] border-border-custom h-full flex-col gap-10 relative">
        ...
        <div className="flex items-start flex-wrap justify-start gap-4 my-12">
          ...
          <div className="flex items-start flex-wrap justify-start gap-4 flex-col mt-4">
            <span className="text-8xl font-bebasNeue tracking-[0.2em] ">
              LET’S WORK TOGETHER
            </span>
          </div>
        </div>
